...
- 安装版：文件名包含 `setup`，安装后可以自动检查并安装更新，也可以点击左侧的“检查更新”。
...
打开左侧“界面设置”，可以在 TI 红、科技蓝、青绿色和紫色四套 MD3 风格全局配色之间切换。背景、Surface 容器、边框、文字和强调色会一起变化；选择会立即生效并保存在本机，不会影响工程文件或开发环境配置。
...
- 作者：[zuoliangyu 的哔哩哔哩主页](https://space.bilibili.com/27619688)
